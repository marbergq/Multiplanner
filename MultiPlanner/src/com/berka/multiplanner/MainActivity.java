...
public class MainActivity extends FragmentActivity {
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		{
		case 0:{
			Planner p= ((SearchFragment)mSectionsPagerAdapter.getItem(0)).getPlanner();
			if(p!=null)
			{
				...
				list.clear();
				outState.putString("TO", p.getTo().getTheJSONBluePrint().toString());
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        {
        	if(fragments.size() <= 2){
	        	DetailsFragment fra = new DetailsFragment();
        	...
        	{
        		DetailsFragment fra = (DetailsFragment)fragments.get(getCount()-1);
        		this.notifyDataSetChanged();
            	ac.getViewPager().setCurrentItem(getCount()-1,true);
        		fra.setData(data);
        ...
        public void ShowResults(Planner planner)
        {
        	...
        	}else if(getCount() == 3)
        	{
        		...
        		//DetailsFragment fragment2 = (DetailsFragment)fragments.get(2);
        		fra.setPlanner(planner);
        		this.notifyDataSetChanged();
